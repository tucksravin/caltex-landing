<script lang='ts'>
  ...
  {/if}
	...
	<section id="s3" class="w-screen mt-24 lg:mt-52 relative">
	...
	<section id="s4" class="w-screen bg-primary text-white mt-10 lg:mt-24 py-10 lg:py-24 relative">
		<ContentWidth class="flex flex-col gap-10 lg:gap-20">
			...
			<div class="w-full flex justify-center flex-wrap text-white">
				...
				<div class="w-full md:w-1/2 pb-10 {i%2==0? "md:pr-5":"md:pl-5"}">
					<div class="w-full aspect-[4/3] lg:aspect-video flex flex-col items-start justify-end gap-6 relative rounded-xl overflow-hidden p-6">
			...
			<div class="w-screen h-52 sm:h-40 p-8 bg-black text-white rounded-lg items-start flex gap-8 overflow-hidden">
